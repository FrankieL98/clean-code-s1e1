...
var createNewTaskElement = function(taskString){
  ...
  editButton.className = 'list__button_edit button';

  deleteButton.className = 'list__button_delete button';
  deleteButtonImg.src = './remove.svg';
  deleteButtonImg.className = 'list__remove-pic';
...
var editTask = function() {
  ...
  var editBtn = listItem.querySelector('.list__button_edit');
  var containsClass = listItem.classList.contains('list__item-task_edit-mode');
  ...
  listItem.classList.toggle('list__item-task_edit-mode');
}
...
var bindTaskEvents = function(taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector('.list__button_edit');
  var deleteButton = taskListItem.querySelector('.list__button_delete');
